...
public class Delay extends Entity {
	...
	public Delay(SimNode ownNode) {
		...
		this.propDelay = new DInfiniteServer(Duration.fromMilliSeconds(0.9), this.simNode.createChildNode("PropergationDelay"));
		
		this.frameTransmissionTime = new UnitPhase(Duration.fromMilliSeconds(0.1), this.simNode.createChildNode("FrameTransmissionTime"));
